...
jest.mock("../resortAnalyzer", () => ({
  analyzeResortConditions: jest.fn().mockResolvedValue({
    structured: {
      snowConditions: "Test snow conditions",
      bestDays: "Test best days",
      alternativeResorts: "Test alternatives",
      advice: "Test advice",
    },
  }),
}));
